...
- (id)safetyObjectForKey:(id)key {
    if ([[self allKeys] containsObject:key]) {
        ...
        if ([obj isKindOfClass:[NSString class]]) {
            return obj == nil || obj == [NSNull null] ? @"" : obj;
        } else if ([obj isKindOfClass:[NSArray class]]) {
            return obj == nil || obj == [NSNull null] ? [NSArray array] : obj;
        } else if ([obj isKindOfClass:[NSMutableArray class]]) {
            return obj == nil || obj == [NSNull null] ? [NSMutableArray array] : obj;
        } else if ([obj isKindOfClass:[NSDictionary class]]) {
            return obj == nil || obj == [NSNull null] ? [NSDictionary dictionary] : obj;
        } else if ([obj isKindOfClass:[NSMutableDictionary class]]) {
            return obj == nil || obj == [NSNull null] ? [NSMutableDictionary dictionary] : obj;
        }
        return obj;
    }
    return @"";
